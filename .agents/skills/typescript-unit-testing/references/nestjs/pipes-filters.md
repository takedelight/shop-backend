...
describe('CustomValidationPipe', () => {
  ...
  it('should throw BadRequestException for invalid email', () => {
    ...
    // Act & Assert
    expect(() => target.transform(invalidData, metadata)).toThrow(
      BadRequestException,
    );
  });
...
describe('ParseIntPipe', () => {
  ...
  it('should throw BadRequestException for non-numeric string', () => {
    ...
    // Act & Assert
    expect(() => target.transform(value, metadata)).toThrow(
      BadRequestException,
    );
  });
...
describe('HttpExceptionFilter', () => {
  ...
  it('should handle BadRequestException with validation errors', () => {
    ...
    mockHost
      .switchToHttp()
      .getRequest.mockReturnValue({ url: '/users', method: 'POST' });
...
describe('AllExceptionsFilter', () => {
  ...
  it('should handle unknown errors', () => {
    ...
    mockHost
      .switchToHttp()
      .getRequest.mockReturnValue({ url: '/api', method: 'GET' });
